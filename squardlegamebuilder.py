...
def generate_random_matrix(size=4, letter_weights=None):
...
found_words = set()
while len(found_words) < 20 or len(found_words) > 80:
    # Generate a random matrix for Squaredle with custom weights
    matrix = generate_random_matrix(size=4, letter_weights=custom_weights)
